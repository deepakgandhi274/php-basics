...
<?php 
      ...
      if(isset($login))
      {
        // echo "<pre>";
        // print_r($_POST);
        $sql="select email_id,mob_no,pass,type,status from sign_up where email_id='$username' and pass='$password'";
        ...
        if($username==$email_id or $username==$mob_no and $pass==$password)
        {
                    ...
                    if($type=="user")
                    {
                        ...
                        if($status==0)
                        {
                             $_SESSION['wait_key']=$email_id;
                                header("location:user_verfication.php");
                        }
                    }
                    if($type=="admin")
                    {
